...
namespace Files.Core.SourceAnalyzer.CodeFixProviders
{
	/// <summary>
	...
	{
		/// <summary>
		/// Title for the code fix.
		/// </summary>
		private const string Title = $"Replace with constant from {StringsPropertyAnalyzer.StringsClassName}";

		/// <summary>
		/// Gets a list of diagnostic IDs that this provider can fix.
		/// </summary>
		public sealed override ImmutableArray<string> FixableDiagnosticIds => [StringsPropertyAnalyzer.DiagnosticId];
		...
		public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
		{
			...
			var constantName = diagnostic.Properties[StringsPropertyAnalyzer.ConstantNameProperty];
			var newExpression = SyntaxFactory.ParseExpression($"{StringsPropertyAnalyzer.StringsClassName}.{constantName}").WithTriviaFrom(node);
