...
namespace Files.Uwp.ViewModels
{
    public class ToolbarViewModel : ObservableObject, IAddressToolbar, IDisposable
    {
        ...
        public List<ListedItem> SelectedItems
        {
            ...
            set
            {
                if (SetProperty(ref selectedItems, value))
                {
                    ...
                    OnPropertyChanged(nameof(IsMultipleImagesSelected));
        ...
        public bool IsMultipleImagesSelected => SelectedItems is not null && SelectedItems.Count > 1 && SelectedItems.All(x => FileExtensionHelpers.IsImageFile(x.FileExtension)) && !InstanceViewModel.IsPageTypeRecycleBin;
