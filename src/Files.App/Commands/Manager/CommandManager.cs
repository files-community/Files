...
namespace Files.App.Commands
{
	internal class CommandManager : ICommandManager
	{
		...
		private IRichCommand _ModifiableDeleteItem;
		public IRichCommand ModifiableDeleteItem => _ModifiableDeleteItem;

		private IRichCommand _ModifiablePasteItem;
		public IRichCommand ModifiablePasteItem => _ModifiablePasteItem;
		...
		public CommandManager()
		{
			...
			_ModifiableDeleteItem = new ModifiableCommand(commands[CommandCodes.DeleteItem], new() {
				{ KeyModifiers.Shift,  commands[CommandCodes.DeleteItemPermanently] }
			});

			_ModifiablePasteItem = new ModifiableCommand(commands[CommandCodes.PasteItem], new() {
				{ KeyModifiers.Shift,  commands[CommandCodes.PasteItemToSelection] }
			});
		...
		private class ModifiableCommand : ObservableObject, IRichCommand
		{
			public event EventHandler? CanExecuteChanged;
