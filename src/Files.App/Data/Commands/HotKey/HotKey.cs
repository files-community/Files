...
namespace Files.App.Data.Commands
{
	...
	public readonly struct HotKey : IEquatable<HotKey>
	{
		...
		public static FrozenDictionary<Keys, string> LocalizedKeys { get; } = new Dictionary<Keys, string>()
		{
			...
			[Keys.Number8] = "8",
			[Keys.Number9] = "9",
			[Keys.A] = GetKeyCharacter(Keys.A),
			[Keys.B] = GetKeyCharacter(Keys.B),
			[Keys.C] = GetKeyCharacter(Keys.C),
			[Keys.D] = GetKeyCharacter(Keys.D),
			[Keys.E] = GetKeyCharacter(Keys.E),
			[Keys.F] = GetKeyCharacter(Keys.F),
			[Keys.G] = GetKeyCharacter(Keys.G),
			[Keys.H] = GetKeyCharacter(Keys.H),
			[Keys.I] = GetKeyCharacter(Keys.I),
			[Keys.J] = GetKeyCharacter(Keys.J),
			[Keys.K] = GetKeyCharacter(Keys.K),
			[Keys.L] = GetKeyCharacter(Keys.L),
			[Keys.M] = GetKeyCharacter(Keys.M),
			[Keys.N] = GetKeyCharacter(Keys.N),
			[Keys.O] = GetKeyCharacter(Keys.O),
			[Keys.P] = GetKeyCharacter(Keys.P),
			[Keys.Q] = GetKeyCharacter(Keys.Q),
			[Keys.R] = GetKeyCharacter(Keys.R),
			[Keys.S] = GetKeyCharacter(Keys.S),
			[Keys.T] = GetKeyCharacter(Keys.T),
			[Keys.U] = GetKeyCharacter(Keys.U),
			[Keys.V] = GetKeyCharacter(Keys.V),
			[Keys.W] = GetKeyCharacter(Keys.W),
			[Keys.X] = GetKeyCharacter(Keys.X),
			[Keys.Y] = GetKeyCharacter(Keys.Y),
			[Keys.Z] = GetKeyCharacter(Keys.Z),
			[Keys.Oem1] = GetKeyCharacter(Keys.Oem1),
			[Keys.Oem2] = GetKeyCharacter(Keys.Oem2),
			[Keys.Oem3] = GetKeyCharacter(Keys.Oem3),
			[Keys.Oem4] = GetKeyCharacter(Keys.Oem4),
			[Keys.Oem5] = GetKeyCharacter(Keys.Oem5),
			[Keys.Oem6] = GetKeyCharacter(Keys.Oem6),
			[Keys.Oem7] = GetKeyCharacter(Keys.Oem7),
			[Keys.Oem8] = GetKeyCharacter(Keys.Oem8),
			[Keys.Oem102] = GetKeyCharacter(Keys.Oem102),
			[Keys.OemPlus] = GetKeyCharacter(Keys.OemPlus),
			[Keys.OemComma] = GetKeyCharacter(Keys.OemComma),
			[Keys.OemMinus] = GetKeyCharacter(Keys.OemMinus),
			[Keys.OemPeriod] = GetKeyCharacter(Keys.OemPeriod),
			[Keys.OemClear] = GetKeyCharacter(Keys.OemClear),
