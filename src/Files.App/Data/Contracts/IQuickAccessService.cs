...
namespace Files.App.Data.Contracts
{
	public interface IQuickAccessService
	{
		...
		/// <returns></returns>
		Task PinToSidebarAsync(string[] folderPaths, bool doUpdateQuickAccessWidget = true);
		...
		/// <returns></returns>
		Task UnpinFromSidebarAsync(string[] folderPaths, bool doUpdateQuickAccessWidget = true);
