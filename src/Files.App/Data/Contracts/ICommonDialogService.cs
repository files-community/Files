...
namespace Files.App.Data.Contracts
{
	...
	public interface ICommonDialogService
	{
		...
		/// <param name="clientGuid">When provided, the dialog persists its state (including the last browsed folder) under this GUID, and <paramref name="defaultFolder"/> only applies the first time the dialog is shown.</param>
		/// <remarks>
		...
		bool Open_FileOpenDialog(nint hWnd, bool pickFoldersOnly, string[] filters, Environment.SpecialFolder defaultFolder, out string filePath, Guid? clientGuid = null);
