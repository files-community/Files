...
namespace Files.App.Utils
{
	public class ListedItem : ObservableObject, IGroupableItem
	{
		...
		public bool IsDriveRoot => ItemPath == PathNormalizeHelper.GetPathRoot(ItemPath);
		...
		private bool CheckElevationRights()
		{
			...
			return IsShortcut
				? AppElevationHelpers.IsElevationRequired(((ShortcutItem)this).TargetPath)
				: AppElevationHelpers.IsElevationRequired(this.ItemPath);
		}
	}
	...
	public class FtpItem : ListedItem
	{
		public FtpItem(FtpListItem item, string folder) : base(null)
		{
			...
			ItemPath = PathNormalizeHelper.Combine(folder, item.Name);
