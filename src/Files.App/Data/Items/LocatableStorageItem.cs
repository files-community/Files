...
{
	public class LocatableStorageItem : ObservableObject, ILocatableSideBarItem
	{
		...
		public BulkConcurrentObservableCollection<ILocatableSideBarItem>? ChildItems { get; set; }
		...
		public static T Create<T>() where T : LocatableStorageItem, new()
		{
			return new T();
		}
	}

	public class RecycleBinLocationItem : LocatableStorageItem
	{
