...
namespace Files.App.Data.Factories
{
	...
	public static class ContentPageContextFlyoutFactory
	{
		...
		public static List<ContextMenuFlyoutItemViewModel> GetItemContextCommandsWithoutShellItems(ShellInstanceViewModel currentInstanceViewModel, List<ListedItem> selectedItems, BaseLayoutViewModel commandsViewModel, bool shiftPressed, SelectedItemsPropertiesViewModel? selectedItemsPropertiesViewModel, ShellViewModel? itemViewModel = null)
		{
		...
		public static List<ContextMenuFlyoutItemViewModel> Filter(List<ContextMenuFlyoutItemViewModel> items, List<ListedItem> selectedItems, bool shiftPressed, ShellInstanceViewModel currentInstanceViewModel, bool removeOverflowMenu = true)
		{
		...
		private static bool Check(ContextMenuFlyoutItemViewModel item, ShellInstanceViewModel currentInstanceViewModel, List<ListedItem> selectedItems)
		{
			return
		...
		public static List<ContextMenuFlyoutItemViewModel> GetBaseItemMenuItems(
			...
			ShellInstanceViewModel currentInstanceViewModel,
