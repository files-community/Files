...
namespace Files.App.Data.Contexts
{
	internal sealed class ContentPageContext : ObservableObject, IContentPageContext
	{
		...
		public StandardStorageItem? Folder => ShellPage?.ShellViewModel?.CurrentFolder;
		...
		private void UpdateSelectedItems()
		{
			...
			IReadOnlyList<StandardStorageItem> items = ShellPage?.AddressToolbarViewModel?.SelectedItems?.AsReadOnly() ?? emptyItems;
