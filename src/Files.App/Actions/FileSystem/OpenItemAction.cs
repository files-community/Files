...
namespace Files.App.Actions
{
	...
	internal sealed class OpenParentFolderAction : ObservableObject, IAction
	{
		...
		public bool IsExecutable =>
			...
			context.ShellPage.CurrentShellViewModel.IsPageTypeSearchResults;
		...
		public async Task ExecuteAsync()
		{
			...
			context.ShellPage.NavigateWithArguments(context.ShellPage.CurrentShellViewModel.FolderSettings.GetLayoutType(folderPath), new NavigationArguments()
			{
