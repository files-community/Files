...
namespace Files.App.Actions
{
	internal sealed class OpenRepoInVSCodeAction : ObservableObject, IAction
	{
		...
		public bool IsExecutable =>
			...
			_context.ShellPage!.CurrentShellViewModel.IsGitRepository;
		...
		{
			return Win32Helper.RunPowershellCommandAsync($"code \'{_context.ShellPage!.CurrentShellViewModel.GitRepositoryPath}\'", false);
		}
