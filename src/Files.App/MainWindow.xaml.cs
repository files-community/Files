			...
			switch (activatedEventArgs)
			{
				case ILaunchActivatedEventArgs launchArgs:
					if (launchArgs.Arguments is not null &&
						...
						|| CommandLineParser.SplitArguments(launchArgs.Arguments, true)[0].Equals(Path.Join(AppRuntimeHelper.EffectivePath, "Files.exe"), StringComparison.OrdinalIgnoreCase)))
					{
