...
namespace Files.App.ViewModels.Settings
{
	public class AppearanceViewModel : ObservableObject
	{
		...
		private int selectedThemeIndex = (int)Enum.Parse(typeof(ElementTheme), AppThemeHelper.RootTheme.ToString());
		...
		public string AppThemeBackgroundColor
		{
			...
			set
			{
				if (value != UserSettingsService.AppearanceSettingsService.AppThemeBackgroundColor)
				{
					...
					ResourcesService.SetAppThemeBackgroundColor(CommunityToolkit.WinUI.Helpers.ColorHelper.ToColor(value).FromWindowsColor());
					ResourcesService.ApplyResources();
