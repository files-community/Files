...
namespace Files.App.ViewModels.UserControls.Widgets.Bundles
{
	/// <summary>
	...
	public class BundleContainerViewModel : ObservableObject, IDisposable
	{
		...
		{
			if (FilesystemHelpers.HasDraggedStorageItems(e.DataView) || e.DataView.Contains(StandardDataFormats.Text))
			{
