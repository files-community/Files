...
namespace Files.App.ViewModels.UserControls
{
	public sealed class AddressToolbarViewModel : ObservableObject, IAddressToolbarViewModel, IDisposable
	{
		...
		public bool IsSelectionArchivesOnly => SelectedItems is not null && SelectedItems.Any() && SelectedItems.All(x => !x.IsFolder && FileExtensionHelpers.IsZipFile(x.FileExtension)) && !InstanceViewModel.IsPageTypeRecycleBin;
