...
{
	public class DynamicViewModel : ObservableObject, IDisposable
	{
		...
		/// OnPrimary action.
		/// </summary>
		public Action<DynamicViewModel, ContentDialogButtonClickEventArgs> PrimaryButtonAction
		{
		...
		private Action<DynamicViewModel, ContentDialogButtonClickEventArgs> secondaryButtonAction;

		/// <summary>
		/// OnSecondary action.
		/// </summary>
		public Action<DynamicViewModel, ContentDialogButtonClickEventArgs> SecondaryButtonAction
		{
		...
		private Action<DynamicViewModel, ContentDialogButtonClickEventArgs> closeButtonAction;

		/// <summary>
		/// OnClose action.
		/// </summary>
		public Action<DynamicViewModel, ContentDialogButtonClickEventArgs> CloseButtonAction
		{
		...
		private Action<DynamicViewModel, KeyRoutedEventArgs> keyDownAction;
		...
		/// This action is assigned by default.
		/// </summary>
		public Action<DynamicViewModel, KeyRoutedEventArgs> KeyDownAction
		{
			get => keyDownAction;
			set
			{
		...
		private Action<DynamicViewModel, RoutedEventArgs> displayControlOnLoaded;

		public Action<DynamicViewModel, RoutedEventArgs> DisplayControlOnLoaded
		{
