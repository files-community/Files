...
namespace Files.App.ViewModels.Dialogs
{
	public class ReorderSidebarItemsDialogViewModel : ObservableObject
	{
		...
		public ObservableCollection<LocatableStorageItem> SidebarFavoriteItems = new(App.QuickAccessManager.Model.favoriteList
			.Where(x => x is LocatableStorageItem loc && loc.Section is SectionType.Favorites && !loc.IsHeader)
			.Cast<LocatableStorageItem>());
