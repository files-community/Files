...
{
	internal class DrivePropertyViewModel : BaseViewModel
	{
		public DriveItem Drive { get; }

		public DrivePropertyViewModel(SelectedItemsPropertiesViewModel viewModel, DriveItem driveItem, IShellPage instance)
		{
			ViewModel = viewModel;
			Drive = driveItem;
