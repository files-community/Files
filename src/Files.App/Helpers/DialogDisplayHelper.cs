...
{
	/// <summary>
	/// Provides a consistent dialog displaying handler.
	/// </summary>
	internal class DialogDisplayHelper
	{
		...
		/// <param name="primaryText">Text to be displayed on the primary button (which returns true when pressed).
		/// If not set, defaults to 'OK'.</param>
		/// <param name="secondaryText">The (optional) secondary button text. If not set, it won't be presented to the user at all.</param>
		/// <returns>True if the user presses primary text button otherwise, false.</returns>
