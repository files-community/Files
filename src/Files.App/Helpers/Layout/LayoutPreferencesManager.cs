...
namespace Files.App.Data.Models
{
	...
	public class LayoutPreferencesManager : ObservableObject
	{
		...
		public static void SetLayoutPreferencesForPath(string path, LayoutPreferencesItem preferencesItem)
		{
			...
			{
				var folderFRN = InteropHelper.GetFolderFRN(path);
		...
		{
			var str = InteropHelper.ReadStringFromFile($"{path}:files_layoutmode");
			...
			InteropHelper.DeleteFileFromApp($"{path}:files_layoutmode");
