...
namespace Files.App.Helpers
{
	public class MenuFlyoutHelper : DependencyObject
	{
		...
		public static IEnumerable<IMenuFlyoutItemViewModel> GetItemsSource(DependencyObject obj)
			=> obj.GetValue(ItemsSourceProperty) as IEnumerable<IMenuFlyoutItemViewModel>;

		public static void SetItemsSource(DependencyObject obj, IEnumerable<IMenuFlyoutItemViewModel> value)
			=> obj.SetValue(ItemsSourceProperty, value);

		private static void ItemsSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
			=> SetupItemsAsync(d as MenuFlyout);

		public static bool GetIsVisible(DependencyObject d)
			=> (bool)d.GetValue(IsVisibleProperty);
