...
namespace Files.App.Helpers
{
	...
	public static class AppLifecycleHelper
	{
		...
		/// </summary>
		/// <param name="appModel">Constructed on the UI thread before the container builds on a
		/// background thread: its constructor subscribes Clipboard.ContentChanged, which is UI-thread-only.</param>
