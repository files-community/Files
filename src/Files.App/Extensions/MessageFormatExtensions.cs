...
namespace Files.App.Extensions
{
	...
	public static class MessageFormatExtensions
	{
		...
		/// </summary>
		private static readonly MessageFormatter _formatter = new(useCache: false, culture: CultureInfo.GetCultureInfo(_locale.TwoLetterISOLanguageName), customValueFormatter: _customFormatter);
