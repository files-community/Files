...
namespace Files.App.UserControls.Widgets
{
	...
	public sealed partial class DrivesWidget : HomePageWidget, IWidgetItemModel, INotifyPropertyChanged
	{
		...
		{
			var drive = ItemsAdded.Where(x => string.Equals(PathNormalizeHelper.NormalizePath(x.Path), PathNormalizeHelper.NormalizePath(item.Path), StringComparison.OrdinalIgnoreCase)).FirstOrDefault();
