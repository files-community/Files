...
namespace Files.App.Utils.Cloud
{
	public static class CloudDrivesManager
	{
		...
		private static readonly List<LocatableDriveItem> _Drives = new();
		public static IReadOnlyList<LocatableDriveItem> Drives
		{
			get
			{
				lock (_Drives)
		...
		public static async Task UpdateDrivesAsync()
		{
			...
			foreach (var provider in providers)
			{
				...
				var cloudProviderItem = new LocatableDriveItem()
				{
					Text = provider.Name,
