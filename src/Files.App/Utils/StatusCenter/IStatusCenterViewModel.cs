...
{
	public interface IStatusCenterViewModel
	{
		event EventHandler<StatusCenterPostedItem> ProgressBannerPosted;
		...
		StatusCenterPostedItem PostBanner(string title, string message, int initialProgress, ReturnResult status, FileOperationType operation);
		...
		StatusCenterPostedItem PostActionBanner(string title, string message, string primaryButtonText, string cancelButtonText, Action primaryAction);
		...
		/// <returns></returns>
		StatusCenterPostedItem PostOperationBanner(string title, string message, int initialProgress, ReturnResult status, FileOperationType operation, CancellationTokenSource cancellationTokenSource);
		...
		bool CloseBanner(StatusCenterItem banner);

		/// <summary>
		/// Communicates a banner's progress or status has changed
		/// </summary>
		/// <param name="banner"></param>
		void UpdateBanner(StatusCenterItem banner);
	}
}
