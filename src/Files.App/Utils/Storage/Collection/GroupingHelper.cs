...
{
	/// <summary>
	/// Provides static helper for grouping storage enumeration.
	/// </summary>
	public static class GroupingHelper
	{
		private static IDateTimeFormatter DateTimeFormatter { get; } = Ioc.Default.GetRequiredService<IDateTimeFormatter>();
