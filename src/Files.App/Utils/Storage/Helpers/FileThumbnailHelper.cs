...
namespace Files.App.Utils.Storage
{
	public static class FileThumbnailHelper
	{
		public static Task<(byte[] IconData, byte[] OverlayData, bool isIconCached)> LoadIconAndOverlayAsync(string filePath, uint thumbnailSize, bool isFolder = false, bool getThumbnailOnly = false, bool getIconOnly = false)
			=> Win32Helper.StartSTATask(() => Win32Helper.GetFileIconAndOverlay(filePath, (int)thumbnailSize, isFolder, getThumbnailOnly, getIconOnly));
		...
		{
			return (await Win32Helper.StartSTATask(() => Win32Helper.GetFileIconAndOverlay(filePath, (int)thumbnailSize, isFolder, getThumbnailOnly, getIconOnly))).icon;
		}
