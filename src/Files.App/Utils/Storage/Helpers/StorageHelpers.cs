...
namespace Files.App.Helpers
{
	...
	public static class StorageHelpers
	{
		...
		public static async Task<TRequested> ToStorageItem<TRequested>(string path) where TRequested : IStorageItem
		{
			...
			// Fast get attributes
			bool exists = Win32InteropHelper.GetFileAttributesExFromApp(path, Win32InteropHelper.GET_FILEEX_INFO_LEVELS.GetFileExInfoStandard, out Win32InteropHelper.WIN32_FILE_ATTRIBUTE_DATA itemAttributes);
		...
		{
			return Win32InteropHelper.GetFileAttributesExFromApp(path, Win32InteropHelper.GET_FILEEX_INFO_LEVELS.GetFileExInfoStandard, out _);
		}
