...
namespace Files.App.Views.Shells
{
	public sealed partial class ModernShellPage : BaseShellPage
	{
		...
		public override void Up_Click()
		{
			...
			bool isPathRooted = string.Equals(FilesystemViewModel.WorkingDirectory, StoragePathHelper.GetPathRoot(FilesystemViewModel.WorkingDirectory), StringComparison.OrdinalIgnoreCase);
			if (isPathRooted)
			{
				ItemDisplayFrame.Navigate(
					typeof(HomePage),
