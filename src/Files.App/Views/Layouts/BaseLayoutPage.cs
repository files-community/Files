	...
	public abstract class BaseLayoutPage : Page, IBaseLayoutPage, INotifyPropertyChanged
	{
		...
		protected override async void OnNavigatedTo(NavigationEventArgs e)
		{
			...
			if (!navigationArguments.IsSearchResultPage)
			{
				...
				ParentShellPageInstance.InstanceViewModel.IsPageTypeFtp = FtpStorageHelper.IsFtpPath(workingDir);
			...
			else
			{
				...
				if (!navigationArguments.IsLayoutSwitch)
				{
					...
					var searchInstance = new Utils.Storage.StorageSearchManager
					{
