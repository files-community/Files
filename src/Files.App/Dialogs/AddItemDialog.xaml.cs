...
namespace Files.App.Dialogs
{
	...
	{
		private readonly IAddItemTypesService addItemTypesService = Ioc.Default.GetRequiredService<IAddItemTypesService>();
		...
		{
			var itemTypes = await addItemTypesService.GetNewEntriesAsync();
