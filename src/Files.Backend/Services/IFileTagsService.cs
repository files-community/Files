...
namespace Files.Backend.Services
{
	...
	public interface IFileTagsService
	{
		...
		/// <param name="cancellationToken">A <see cref="CancellationToken"/> that cancels this action.</param>
		/// <returns>Returns an async operation represented by <see cref="IAsyncEnumerable{T}"/> of type <see cref="TagModel"/>.</returns>
		IAsyncEnumerable<TagModel> GetItemsForTagAsync(string tag, CancellationToken cancellationToken);
