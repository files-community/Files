...
- Delete the manual method, struct, enum, or constant once no callers remain.
...
- COM APIs such as `CoCreateInstance` and `SHCreateItemFromParsingName` often require unsafe pointer overloads:
