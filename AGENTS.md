...
- For Win32, COM, Shell, clipboard, hotkey, and file operation interop, prefer `src/Files.App.Storage`, `NativeMethods.txt`, and existing wrappers/helpers.
...
- Add app runtime CsWin32 APIs to `src/Files.App.Storage/NativeMethods.txt` or the owning app project's `NativeMethods.txt`, and keep test-only APIs in the relevant test project's `NativeMethods.txt`; do not edit generated CsWin32 output.
...
├── Files.App.Storage            Storage, implementations, and shared app Win32 interop
