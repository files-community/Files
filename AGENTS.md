...
- Never retain or pass the address of a local from an async method across suspension; the async state machine can move it during GC and cause memory corruption.
