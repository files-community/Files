...
namespace Files.Common
{
    ...
    public class IWin32ContextMenu
    {
        public List<IWin32ContextMenuItem> Items { get; set;  }
    }

    public class IWin32ContextMenuItem
    {
        ...
        public List<IWin32ContextMenuItem> SubItems { get; set; }
    }
}
