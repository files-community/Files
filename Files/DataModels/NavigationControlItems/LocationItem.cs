...
namespace Files.DataModels.NavigationControlItems
{
    public class LocationItem : ObservableObject, INavigationControlItem
    {
        ...
        public string Path
        {
            ...
            {
                path = value;
                HoverDisplayText = string.IsNullOrEmpty(Path) || Path.Contains("?") || Path.ToLower().StartsWith("shell:") || Path.ToLower().EndsWith(ShellLibraryItem.EXTENSION) || Path == "Home".GetLocalized() ? Text : Path;
            }
        }
