...
namespace Files.ViewModels
{
    public class SettingsViewModel : ObservableObject
    {
        ...
        /// Gets or sets a value indicating whether or not to show the library section on the sidebar.
        /// </summary>
        public bool IsLibraryItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is favorites item expanded.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is favorites item expanded; otherwise, <c>false</c>.
        /// </value>
        public bool IsFavoritesItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is drives item expanded.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is drives item expanded; otherwise, <c>false</c>.
        /// </value>
        public bool IsDrivesItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is network item expanded.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is network item expanded; otherwise, <c>false</c>.
        /// </value>
        public bool IsNetworkItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is cloud drives item expanded.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is cloud drives item expanded; otherwise, <c>false</c>.
        /// </value>
        public bool IsCloudDrivesItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is WSL item expanded.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is WSL item expanded; otherwise, <c>false</c>.
        /// </value>
        public bool IsWSLItemExpanded
        {
            get => Get(false);
            set => Set(value);
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [remember sidebar state].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [remember sidebar state]; otherwise, <c>false</c>.
        /// </value>
