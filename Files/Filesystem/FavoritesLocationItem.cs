...
{
    public class FavoritesLocationItem : LocationItem
    {
        ...
        public FavoritesLocationItem(ShellLibraryItem shellLibrary)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is FavoritesLocationItem other && string.Equals(Path, other.Path, System.StringComparison.OrdinalIgnoreCase);
        }
