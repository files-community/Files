...
{
    public class DrivesLocationItem : LocationItem
    {
        ...
        public DrivesLocationItem(ShellLibraryItem shellLibrary)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is DrivesLocationItem other && string.Equals(Path, other.Path, System.StringComparison.OrdinalIgnoreCase);
        }
