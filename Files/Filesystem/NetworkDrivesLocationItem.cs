...
{
    public class NetworkDrivesLocationItem : LocationItem
    {
        ...
        public NetworkDrivesLocationItem(ShellLibraryItem shellLibrary)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is NetworkDrivesLocationItem other && string.Equals(Path, other.Path, System.StringComparison.OrdinalIgnoreCase);
        }
