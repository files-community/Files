...
{
    public class CloudDrivesLocationItem : LocationItem
    {
        ...
        public CloudDrivesLocationItem(ShellLibraryItem shellLibrary)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is CloudDrivesLocationItem other && string.Equals(Path, other.Path, System.StringComparison.OrdinalIgnoreCase);
        }
